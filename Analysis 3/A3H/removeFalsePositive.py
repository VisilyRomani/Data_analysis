...
if __name__ == '__main__':
    ...
    mergedDFUp.to_csv('C:/Users/micha/PycharmProjects/IPOND/A3H/DATA/merged_up.csv', index = False, header=True)
    mergedDFDown.to_csv('C:/Users/micha/PycharmProjects/IPOND/A3H/DATA/merged_down.csv', index = False, header=True)
