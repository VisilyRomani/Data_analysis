...
DOWNI_v_EDU = pd.read_csv('Raw/DOWN_I vs EdU.csv')
DOWNU_v_EDU = pd.read_csv('Raw/DOWN_U vs EdU.csv')

UPI_v_U = pd.read_csv('Raw/UP_I vs U.csv')
DOWNI_v_U = pd.read_csv('Raw/DOWN_I vs U.csv')
...
if __name__ == '__main__':
    ...
    mergedDFUp.to_csv('C:/Users/micha/PycharmProjects/IPOND/DATA/merged_up.csv', index = False, header=True)
    mergedDFDown.to_csv('C:/Users/micha/PycharmProjects/IPOND/DATA/merged_down.csv', index = False, header=True)
